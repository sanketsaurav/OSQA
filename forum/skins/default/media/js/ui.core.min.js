...
"overflow",1)+b.curCSS(this,"overflow-y",1)+b.curCSS(this,"overflow-x",1))}).eq(0);return/fixed/.test(this.css("position"))||!a.length?b(document):a}});b.extend(b.expr[":"],{data:function(a,d,c){return!!b.data(a,c[3])},focusable:function(a){var d=a.nodeName.toLowerCase(),c=b.attr(a,"tabindex");return(/input|select|textarea|button|object/.test(d)?!a.disabled:"a"==d||"area"==d?a.href||!isNaN(c):!isNaN(c))&&!b(a)["area"==d?"parents":"closest"](":hidden").length},tabbable:function(a){var d=b.attr(a,"tabindex");
return(isNaN(d)||0<=d)&&b(a).is(":focusable")}});b.widget=function(a,d){var c=a.split(".")[0],a=a.split(".")[1];b.fn[a]=function(d){var f="string"==typeof d,g=Array.prototype.slice.call(arguments,1);if(f&&"_"==d.substring(0,1))return this;if(f&&l(c,a,d,g)){var k=b.data(this[0],a);return k?k[d].apply(k,g):void 0}return this.each(function(){var i=b.data(this,a);!i&&!f&&b.data(this,a,new b[c][a](this,d))._init();i&&f&&b.isFunction(i[d])&&i[d].apply(i,g)})};b[c]=b[c]||{};b[c][a]=function(d,f){var g=this;
this.namespace=c;this.widgetName=a;this.widgetEventPrefix=b[c][a].eventPrefix||a;this.widgetBaseClass=c+"-"+a;this.options=b.extend({},b.widget.defaults,b[c][a].defaults,b.metadata&&b.metadata.get(d)[a],f);this.element=b(d).bind("setData."+a,function(a,b,c){if(a.target==d)return g._setData(b,c)}).bind("getData."+a,function(a,b){if(a.target==d)return g._getData(b)}).bind("remove",function(){return g.destroy()})};b[c][a].prototype=b.extend({},b.widget.prototype,d);b[c][a].getterSetter="option"};b.widget.prototype=
...
b.widget.defaults={disabled:!1};b.ui.mouse={_mouseInit:function(){var a=this;this.element.bind("mousedown."+this.widgetName,function(b){return a._mouseDown(b)}).bind("click."+this.widgetName,function(b){if(a._preventClickEvent)return a._preventClickEvent=!1,b.stopImmediatePropagation(),!1});b.browser.msie&&(this._mouseUnselectable=this.element.attr("unselectable"),this.element.attr("unselectable","on"));this.started=!1},_mouseDestroy:function(){this.element.unbind("."+this.widgetName);b.browser.msie&&
...
!0},this.options.delay));if(this._mouseDistanceMet(a)&&this._mouseDelayMet(a)&&(this._mouseStarted=!1!==this._mouseStart(a),!this._mouseStarted))return a.preventDefault(),!0;this._mouseMoveDelegate=function(a){return d._mouseMove(a)};this._mouseUpDelegate=function(a){return d._mouseUp(a)};b(document).bind("mousemove."+this.widgetName,this._mouseMoveDelegate).bind("mouseup."+this.widgetName,this._mouseUpDelegate);b.browser.safari||a.preventDefault();return a.originalEvent.mouseHandled=!0}},_mouseMove:function(a){if(b.browser.msie&&
!a.button)return this._mouseUp(a);if(this._mouseStarted)return this._mouseDrag(a),a.preventDefault();this._mouseDistanceMet(a)&&this._mouseDelayMet(a)&&((this._mouseStarted=!1!==this._mouseStart(this._mouseDownEvent,a))?this._mouseDrag(a):this._mouseUp(a));return!this._mouseStarted},_mouseUp:function(a){b(document).unbind("mousemove."+this.widgetName,this._mouseMoveDelegate).unbind("mouseup."+this.widgetName,this._mouseUpDelegate);this._mouseStarted&&(this._mouseStarted=!1,this._preventClickEvent=
