...
function pickedTags(){var a=function(a,b,c,d){var f=scriptUrl;"add"==c?(f+=$.i18n._("mark-tag/"),f="good"==b?f+$.i18n._("interesting/"):f+$.i18n._("ignored/")):f+=$.i18n._("unmark-tag/");a={type:"POST",url:f+a+"/",data:""};!1!==d&&(a.success=d);$.ajax(a)},c=function(b,c,d,e){var f=function(){b[c].remove();delete b[c]};e?a(c,d,"remove",f):f()},b=function(a,b,d,e,f){a.unbind("mouseover").bind("mouseover",function(){$(this).attr("src",mediaUrl("media/images/close-small-hover.png"))});a.unbind("mouseout").bind("mouseout",
function(){$(this).attr("src",mediaUrl("media/images/close-small-dark.png"))});a.click(function(){c(b,d,e,f)})},d=function(d,e){var g=$.trim($(d).prev().attr("value")),h=interestingTags,f=ignoredTags,p;if("bad"==e)h=ignoredTags,f=interestingTags,p=$("div .tags.ignored");else{if("good"!=e)return;p=$("div .tags.interesting")}g in f&&c(f,g,e,!1);g in h||a(g,e,"add",function(){var a=$("<span></span>");a.addClass("deletable-tag");var c=$("<a></a>");c.attr("rel","tag");c.attr("href",scriptUrl+$.i18n._("tags/")+
g+"/");c.html(g);var d=$("<img />");d.addClass("delete-icon");d.attr("src",mediaUrl("media/images/close-small-dark.png"));b(d,h,g,e,!0);a.append(c);a.append(d);p.append(a);h[g]=a})},e=function(){var a=/^interesting-tag-/,c=/^ignored-tag-/;interestingTags={};ignoredTags={};$(".deletable-tag").each(function(d,e){var f=$(e).attr("id"),g;if(a.test(f))f=f.replace("interesting-tag-",""),g=interestingTags,reason="good";else if(c.test(f))f=f.replace("ignored-tag-",""),g=ignoredTags,reason="bad";else return;
g[f]=$(e);b($(e).find("img"),g,f,reason,!0)})},g=function(){$("#hideIgnoredTagsCb").unbind("click").click(function(){$.ajax({type:"POST",dataType:"json",cache:!1,url:scriptUrl+$.i18n._("command/"),data:{command:"toggle-ignored-questions"}})})};return{init:function(){e();g();$("#interestingTagInput, #ignoredTagInput").autocomplete(messages.matching_tags_url,{minChars:1,matchContains:!0,max:20,formatItem:function(a){return a[1]+" ("+a[2]+")"},formatResult:function(a){return a[1]}});$("#interestingTagAdd").click(function(){d(this,
"good")});$("#ignoredTagAdd").click(function(){d(this,"bad")})}}}
