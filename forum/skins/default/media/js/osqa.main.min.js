$("html").ajaxSend(function(a,c,b){function d(a){var b=null;if(document.cookie&&""!=document.cookie)for(var c=document.cookie.split(";"),d=0;d<c.length;d++){var j=jQuery.trim(c[d]);if(j.substring(0,a.length+1)==a+"="){b=decodeURIComponent(j.substring(a.length+1));break}}return b}try{!/^http:.*/.test(b.url)&&!/^https:.*/.test(b.url)&&c.setRequestHeader("X-CSRFToken",d("csrftoken"))}catch(e){}});
...
remove_comment:function(a){var c=$("#comment-"+a);c.css("background","red");c.fadeOut("slow",function(){c.remove()})},award_points:function(){alert("ok")},insert_comment:function(a,c,b,d,e,f,k,i,g,j){var h=$("#comments-container-"+a),a=$("#new-comment-skeleton-"+a).html().toString(),a=a.replace(RegExp("%ID%","g"),c).replace(RegExp("%COMMENT%","g"),b).replace(RegExp("%USERNAME%","g"),d).replace(RegExp("%PROFILE_URL%","g"),e).replace(RegExp("%DELETE_URL%","g"),f).replace(RegExp("%EDIT_URL%","g"),k).replace(RegExp("%CONVERT_URL%",
"g"),i);j?h.prepend(a):h.append(a);!0==g&&$("#comment-"+c+"-convert").show();$("#comment-"+c).slideDown("slow")},update_comment:function(a,c){var b=$("#comment-"+a);b.find(".comment-text").html(c);b.slideDown("slow")},mark_deleted:function(a,c){"question"==a?$("#question-table").addClass("deleted"):$("#"+a+"-container-"+c).addClass("deleted")},unmark_deleted:function(a,c){"answer"==a?$("#answer-container-"+c).removeClass("deleted"):$("#question-table").removeClass("deleted")},set_subscription_button:function(a){$(".subscription_switch").html(a)},
...
function onready_function(){$("textarea.commentBox").bind("keydown keyup mousedown mouseup mousemove",function(){comment_box_cursor_position=$(this).caret().start});$("textarea.commentBox").blur(function(){});$("a.ajax-command").live("click",function(a){if(running)return!1;var b=$(this),c=b.attr("href"),c=c+"?nocache="+(new Date).getTime();$(".context-menu-dropdown").slideUp("fast");if(b.is(".withprompt"))load_prompt(a,b,c);else if(b.is(".confirm")){var d={html:messages.confirm,extra_class:"confirm",
yes_callback:function(){start_command();$.getJSON(c,function(b){process_ajax_response(b,a);e.fadeOut("fast",function(){e.remove()})})},yes_text:messages.yes,show_no:!0,no_text:messages.no};b.is(".centered")||(d.event=a);var e=show_dialog(d)}else start_command(),$.getJSON(c,function(b){process_ajax_response(b,a)});return!1});$(".context-menu").each(function(){var a=$(this),b=a.find(".context-menu-trigger"),c=a.find(".context-menu-dropdown");b.click(function(){c.slideToggle("fast",function(){if(c.is(":visible"))c.one("clickoutside",
function(){c.is(":visible")&&c.slideUp("fast")})})})});$("div.comment-form-container").each(function(){var a=$(this),b=a.parent().find(".comment-tools"),c=a.parent().find(".comments-container"),d=a.find("form");if(d.length){var e=a.find("textarea"),k=e.get(0),f=a.find(".comment-submit"),n=a.find(".comment-cancel"),m=a.find(".comments-chars-left-msg"),s=a.find(".comments-chars-togo-msg"),q=a.find(".comments-char-left-count"),u=b.find(".add-comment-link"),o=q.html().split("|"),t=parseInt(o[0]),y=parseInt(o[1]),
z=y-30,w=0,v=!1,x=null,D=!($.browser.msie||$.browser.opera);e.css("padding-top",0).css("padding-bottom",0).css("resize","none");k.style.overflow="hidden";var A=function(){e.val("");e.css("height",80);q.html(y);m.removeClass("warn");v=!1;w=0;m.hide();s.show();q.removeClass("warn");q.html(t);f.attr("disabled","disabled");x=null};A();var B=function(){a.slideDown("slow");u.fadeOut("slow");e.focus();x=window.setInterval(function(){var a=e.val().replace(/[ ]{2,}/g," ").length;if(w!=a){a<z&&w>=z?q.removeClass("warn"):
w<z&&a>=z&&q.addClass("warn");a<t?(m.hide(),s.show(),q.html(t-a)):(a=e.val().length,s.hide(),m.show(),q.html(y-a));a>y||a<t?f.attr("disabled","disabled"):f.removeAttr("disabled");var b=k.style.height;D&&(k.style.height="0px");var c=Math.max(80,k.scrollHeight);k.style.height=b;e.animate({height:c+"px"},50);w=a}},200)},C=function(){null!=x&&(window.clearInterval(x),x=null);a.slideUp("slow");u.fadeIn("slow")};u.click(function(){A();B();return!1});$("#"+c.attr("id")+" .comment-edit").live("click",function(){var a=
$(this),b=/comment-(\d+)-edit/.exec(a.attr("id"))[1],c=$("#comment-"+b);v=b;$.get(a.attr("href"),function(a){e.val(a)});c.slideUp("slow");B();return!1});f.click(function(a){if(running)return!1;var b={comment:e.val()};v&&(b.id=v);start_command();$.post(d.attr("action"),b,function(b){process_ajax_response(b,a,function(a){a||(A(),C())})},"json");return!1});e.keydown(function(a){a.ctrlKey&&13==a.keyCode&&!f.attr("disabled")&&$(this).parent().find("input.comment-submit").click()});n.click(function(){confirm("You will lose all of your changes in this comment.  Do you still wish to proceed?")&&
(v&&($comment=$("#comment-"+v).slideDown("slow")),C(),A());return!1})}b.find(".show-all-comments-link").click(function(){c.find(".not_top_scorer").slideDown("slow");$(this).fadeOut("slow");b.find(".comments-showing").fadeOut("slow");return!1})});if($("#editor").length){var a=$("#editor"),c=$("#previewer"),b=$("#editor-metrics"),d=/^[^A-Za-z\u0410-\u042f\u0430-\u044f0-9]+/gi,e=rExp=/[^A-Za-z\u0410-\u042f\u0430-\u044f0-9]+/gi,f=null;a.focus(function(){null==f&&(f=window.setInterval(function(){var a=
c.text(),g=a.length,a=(a+" ").replace(d,"").replace(e," ").split(" ").length-1,g=g+" "+(1==g?messages.character:messages.characters),g=g+(" / "+a+" "+(1==a?messages.word:messages.words));b.html(g)},200))})}$.waypoints.settings.scrollThrottle=30;var a=$("#roof"),k=$("#navBar");a.waypoint(function(a,b){k.toggleClass("sticky","down"===b);a.stopPropagation()})}
function pickedTags(){var a=function(a,b,c,d){var e=scriptUrl;"add"==c?(e+=$.i18n._("mark-tag/"),e="good"==b?e+$.i18n._("interesting/"):e+$.i18n._("ignored/")):e+=$.i18n._("unmark-tag/");a={type:"POST",url:e+a+"/",data:""};!1!==d&&(a.success=d);$.ajax(a)},c=function(b,c,d,e){var h=function(){b[c].remove();delete b[c]};e?a(c,d,"remove",h):h()},b=function(a,b,d,e,h){a.click(function(){c(b,d,e,h);return!1})},d=function(d,e){var g=$.trim($(d).prev().attr("value")),j=interestingTags,h=ignoredTags,f;if("bad"==
e)j=ignoredTags,h=interestingTags,f=$("div .tags.ignored");else{if("good"!=e)return;f=$("div .tags.interesting")}g in h&&c(h,g,e,!1);g in j||a(g,e,"add",function(){var a=$("<span></span>");a.addClass("deletable-tag");var c=$("<a></a>");c.attr("rel","tag");c.attr("href",scriptUrl+$.i18n._("tags/")+g+"/");c.html(g);var d=$("span.delete-icon");b(d,j,g,e,!0);a.append(c);a.append(d);f.append(a);j[g]=a})},e=function(){var a=/^interesting-tag-/,c=/^ignored-tag-/;interestingTags={};ignoredTags={};$(".deletable-tag").each(function(d,
e){var h=$(e).attr("id"),f;if(a.test(h))h=h.replace("interesting-tag-",""),f=interestingTags,reason="good";else if(c.test(h))h=h.replace("ignored-tag-",""),f=ignoredTags,reason="bad";else return;f[h]=$(e);b($(e).find("span.delete-icon"),f,h,reason,!0)})},f=function(){$("#hideIgnoredTagsCb").unbind("click").click(function(){$.ajax({type:"POST",dataType:"json",cache:!1,url:scriptUrl+$.i18n._("command/"),data:{command:"toggle-ignored-questions"}})})};return{init:function(){e();f();$("#interestingTagInput, #ignoredTagInput").autocomplete(messages.matching_tags_url,
...
Hilite.decodeReferrerQS=function(a,c){var b=a.indexOf("?"),d;if(0<=b){var e=new String(a.substring(b+1));for(d=b=0;0<=b&&0<=(d=e.indexOf("=",b));){var f;f=e.substring(b,d);b=e.indexOf("&",d)+1;if(f==c)return 0>=b?e.substring(d+1):e.substring(d+1,b-1);if(0>=b)break}}return null};
Hilite.hiliteElement=function(a,c){if(c&&0!=a.childNodes.length){for(var b=[],d=0;d<c.length;d++)c[d]=c[d].toLowerCase(),Hilite.exact?b.push("\\b"+c[d]+"\\b"):b.push(c[d]);for(var b=RegExp(b.join("|"),"i"),e={},d=0;d<c.length;d++)e[c[d]]=Hilite.style_name_suffix?Hilite.style_name+(d+1):Hilite.style_name;Hilite.walkElements(a.childNodes[0],1,function(a){var c=b.exec(a.data);if(c){var d=c[0],c=a.splitText(c.index);c.splitText(d.length);var g=a.ownerDocument.createElement("SPAN");a.parentNode.replaceChild(g,
c);g.className=e[d.toLowerCase()];g.appendChild(c);return g}return a})}};Hilite.hilite=function(){var a=Hilite.debug_referrer?Hilite.debug_referrer:document.referrer,c=null;(a=Hilite.decodeReferrer(a))&&(Hilite.elementid&&(c=document.getElementById(Hilite.elementid))||(c=document.body))&&Hilite.hiliteElement(c,a)};
...
e=a.split("%s"),f=0;f<b.length;f++)e[f].lastIndexOf("%")==e[f].length-1&&f!=b.length-1&&(e[f]+="s"+e.splice(f+1,1)[0]),d+=e[f]+b[f];return d+e[e.length-1]}}})(jQuery);
...
(function(a){function c(c){e=a(c.data.el);e.blur();k=c.clientY+document.documentElement.scrollTop;f=e.height()-k;e.css("opacity",0.25);a(document).mousemove(b).mouseup(d);return!1}function b(a){var b=a.clientY+document.documentElement.scrollTop,c=f+b;k>=b&&(c-=5);k=b;c=Math.max(i,c);e.height(c+"px");c<i&&d(a);return!1}function d(){a(document).unbind("mousemove",b).unbind("mouseup",d);e.css("opacity",1);e.focus();f=e=null;k=0}var e,f,k=0,i=32;a.fn.TextAreaResizer=function(){return this.each(function(){e=
a(this).addClass("processed");f=null;a(this).wrap('<div class="resizable-textarea"><span></span></div>').parent().append(a('<div class="grippie"></div>').bind("mousedown",{el:this},c));var b=a("div.grippie",a(this).parent())[0];b.style.marginRight=b.offsetWidth-a(this)[0].offsetWidth+"px"})}})(jQuery);
...
setOptions:function(a){return this.trigger("setOptions",[a])},unautocomplete:function(){return this.trigger("unautocomplete")}});a.Autocompleter=function(c,b){var d,e;function f(){var a=o.selected();if(!a)return!1;var c=a.result;n=c;if(b.multiple){var d=i(l.val());1<d.length&&(c=d.slice(0,d.length-1).join(b.multipleSeparator)+b.multipleSeparator+c);c+=b.multipleSeparator}l.val(c);j();l.trigger("result",[a.data,a.value]);return!0}function k(a,c){if(q==d)o.hide();else{var e=l.val();if(c||e!=n)n=e,e=
g(e),e.length>=b.minChars?(l.addClass(b.loadingClass),b.matchCase||(e=e.toLowerCase()),p(e,h,j)):(l.removeClass(b.loadingClass),o.hide())}}function i(c){if(!c)return[""];var c=c.split(b.multipleSeparator),d=[];a.each(c,function(b,c){a.trim(c)&&(d[b]=a.trim(c))});return d}function g(a){if(!b.multiple)return a;a=i(a);return a[a.length-1]}function j(){var d=o.visible();o.hide();clearTimeout(r);l.removeClass(b.loadingClass);b.mustMatch&&l.search(function(a){a||(b.multiple?(a=i(l.val()).slice(0,-1),l.val(a.join(b.multipleSeparator)+
(a.length?b.multipleSeparator:""))):l.val(""))});d&&a.Autocompleter.Selection(c,c.value.length,c.value.length)}function h(d,f){if(f&&f.length&&s){l.removeClass(b.loadingClass);o.display(f,d);var h=f[0].value;b.autoFill&&g(l.val()).toLowerCase()==d.toLowerCase()&&q!=e&&(l.val(l.val()+h.substring(g(n).length)),a.Autocompleter.Selection(c,n.length,n.length+h.length));o.show()}else j()}function p(d,e,f){b.matchCase||(d=d.toLowerCase());var h=m.load(d);if(h&&h.length)e(d,h);else if("string"==typeof b.url&&
0<b.url.length){var j={timestamp:+new Date};a.each(b.extraParams,function(a,b){j[a]="function"==typeof b?b():b});a.ajax({mode:"abort",port:"autocomplete"+c.name,dataType:b.dataType,url:b.url,data:a.extend({q:g(d),limit:b.max},j),success:function(c){var f;if(!(f=b.parse&&b.parse(c))){f=[];for(var c=c.split("\n"),h=0;h<c.length;h++){var g=a.trim(c[h]);g&&(g=g.split("|"),f[f.length]={data:g,value:g[0],result:b.formatResult&&b.formatResult(g,g[0])||g[0]})}}m.add(d,f);e(d,f)}})}else o.emptyList(),f(d)}
d=46;e=8;var l=a(c).attr("autocomplete","off").addClass(b.inputClass),r,n="",m=a.Autocompleter.Cache(b),s=0,q,u={mouseDownOnSelect:!1},o=a.Autocompleter.Select(b,c,f,u),t;a.browser.opera&&a(c.form).bind("submit.autocomplete",function(){if(t)return t=!1});l.bind((a.browser.opera?"keypress":"keydown")+".autocomplete",function(c){q=c.keyCode;switch(c.keyCode){case 38:c.preventDefault();o.visible()?o.prev():k(0,!0);break;case 40:c.preventDefault();o.visible()?o.next():k(0,!0);break;case 33:c.preventDefault();
o.visible()?o.pageUp():k(0,!0);break;case 34:c.preventDefault();o.visible()?o.pageDown():k(0,!0);break;case b.multiple&&","==a.trim(b.multipleSeparator)&&188:case 9:case 13:if(f())return c.preventDefault(),t=!0,!1;break;case 27:o.hide();break;default:clearTimeout(r),r=setTimeout(k,b.delay)}}).focus(function(){s++}).blur(function(){s=0;u.mouseDownOnSelect||(clearTimeout(r),r=setTimeout(j,200))}).click(function(){1<s++&&!o.visible()&&k(0,!0)}).bind("search",function(){function c(a,d){var e;if(d&&d.length)for(var f=
0;f<d.length;f++)if(d[f].result.toLowerCase()==a.toLowerCase()){e=d[f];break}"function"==typeof b?b(e):l.trigger("result",e&&[e.data,e.value])}var b=1<arguments.length?arguments[1]:null;a.each(i(l.val()),function(a,b){p(b,c,c)})}).bind("flushCache",function(){m.flush()}).bind("setOptions",function(c,d){a.extend(b,d);"data"in d&&m.populate()}).bind("unautocomplete",function(){o.unbind();l.unbind();a(c.form).unbind(".autocomplete")})};a.Autocompleter.defaults={inputClass:"ac_input",resultsClass:"ac_results",
...
function(c){function b(a,b){c.matchCase||(a=a.toLowerCase());var d=a.indexOf(b);return-1==d?!1:0==d||c.matchContains}function d(a,b){i>c.cacheLength&&f();k[a]||i++;k[a]=b}function e(){if(!c.data)return!1;var b={},e=0;c.url||(c.cacheLength=1);b[""]=[];for(var f=0,k=c.data.length;f<k;f++){var l=c.data[f],l="string"==typeof l?[l]:l,i=c.formatMatch(l,f+1,c.data.length);if(!1!==i){var n=i.charAt(0).toLowerCase();b[n]||(b[n]=[]);l={value:i,data:l,result:c.formatResult&&c.formatResult(l)||i};b[n].push(l);
e++<c.max&&b[""].push(l)}}a.each(b,function(a,b){c.cacheLength++;d(a,b)})}function f(){k={};i=0}var k={},i=0;setTimeout(e,25);return{flush:f,add:d,populate:e,load:function(d){if(!c.cacheLength||!i)return null;if(!c.url&&c.matchContains){var e=[],f;for(f in k)if(0<f.length){var p=k[f];a.each(p,function(a,c){b(c.value,d)&&e.push(c)})}return e}if(k[d])return k[d];if(c.matchSubset)for(f=d.length-1;f>=c.minChars;f--)if(p=k[d.substr(0,f)])return e=[],a.each(p,function(a,c){b(c.value,d)&&(e[e.length]=c)}),
e;return null}}};a.Autocompleter.Select=function(c,b,d,e){var f;function k(){r&&(n=a("<div/>").hide().addClass(c.resultsClass).css("position","absolute").appendTo(document.body),m=a("<ul/>").appendTo(n).mouseover(function(b){i(b).nodeName&&"LI"==i(b).nodeName.toUpperCase()&&(h=a("li",m).removeClass(f).index(i(b)),a(i(b)).addClass(f))}).click(function(c){a(i(c)).addClass(f);d();b.focus();return!1}).mousedown(function(){e.mouseDownOnSelect=!0}).mouseup(function(){e.mouseDownOnSelect=!1}),0<c.width&&
n.css("width",c.width),r=!1)}function i(a){for(a=a.target;a&&"LI"!=a.tagName;)a=a.parentNode;return!a?[]:a}function g(a){j.slice(h,h+1).removeClass(f);h+=a;0>h?h=j.size()-1:h>=j.size()&&(h=0);a=j.slice(h,h+1).addClass(f);if(c.scroll){var b=0;j.slice(0,h).each(function(){b+=this.offsetHeight});b+a[0].offsetHeight-m.scrollTop()>m[0].clientHeight?m.scrollTop(b+a[0].offsetHeight-m.innerHeight()):b<m.scrollTop()&&m.scrollTop(b)}}f="ac_over";var j,h=-1,p,l="",r=!0,n,m;return{display:function(b,d){k();p=
b;l=d;m.empty();for(var e=c.max&&c.max<p.length?c.max:p.length,g=0;g<e;g++)if(p[g]){var i=c.formatItem(p[g].data,g+1,e,p[g].value,l);!1!==i&&(i=a("<li/>").html(c.highlight(i,l)).addClass(0==g%2?"ac_even":"ac_odd").appendTo(m)[0],a.data(i,"ac_data",p[g]))}j=m.find("li");c.selectFirst&&(j.slice(0,1).addClass(f),h=0);a.fn.bgiframe&&m.bgiframe()},next:function(){g(1)},prev:function(){g(-1)},pageUp:function(){0!=h&&0>h-8?g(-h):g(-8)},pageDown:function(){h!=j.size()-1&&h+8>j.size()?g(j.size()-1-h):g(8)},
hide:function(){n&&n.hide();j&&j.removeClass(f);h=-1},visible:function(){return n&&n.is(":visible")},current:function(){return this.visible()&&(j.filter("."+f)[0]||c.selectFirst&&j[0])},show:function(){var d=a(b).offset();n.css({width:"string"==typeof c.width||0<c.width?c.width:a(b).width(),top:d.top+b.offsetHeight,left:d.left}).show();if(c.scroll&&(m.scrollTop(0),m.css({maxHeight:c.scrollHeight,overflow:"auto"}),a.browser.msie&&"undefined"===typeof document.body.style.maxHeight)){var e=0;j.each(function(){e+=
this.offsetHeight});d=e>c.scrollHeight;m.css("height",d?c.scrollHeight:e);d||j.width(m.width()-parseInt(j.css("padding-left"))-parseInt(j.css("padding-right")))}},selected:function(){var b=j&&j.filter("."+f).removeClass(f);return b&&b.length&&a.data(b[0],"ac_data")},emptyList:function(){m&&m.empty()},unbind:function(){n&&n.remove()}}};a.Autocompleter.Selection=function(a,b,d){if(a.setSelectionRange)a.setSelectionRange(b,d);else if(a.createTextRange){var e=a.createTextRange();e.collapse(!0);e.moveStart("character",
...
(function(a,c,b){function d(d,f){function k(b){a(i).each(function(){var c=a(this);this!==b.target&&!c.has(b.target).length&&c.triggerHandler(f,[b.target])})}var f=f||d+b,i=a(),g=d+"."+f+"-special-event";a.event.special[f]={setup:function(){i=i.add(this);1===i.length&&a(c).bind(g,k)},teardown:function(){i=i.not(this);0===i.length&&a(c).unbind(g)},add:function(a){var b=a.handler;a.handler=function(a,c){a.target=c;b.apply(this,arguments)}}}}a.map("click,dblclick,mousemove,mousedown,mouseup,mouseover,mouseout,change,select,submit,keydown,keypress,keyup".split(","),
